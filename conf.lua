function love.conf(t)
    t.identity = TinyTank                    -- The name of the save directory (string)
    ...
    t.window.title = "Tiny Tank"             -- The window title (string)
    t.window.icon = "DotLib/icon3.png"                 -- Filepath to an image to use as the window's icon (string)
